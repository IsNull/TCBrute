...
//
// Taken from http://gitorious.org/ironahk/mainline/blobs/master/Rusty/Extras/CRC32.cs
//

namespace truecryptbrute.Crypto
{
    /// <summary>
    ...
    class CRC32 : HashAlgorithm
    {
        ...
        public static uint UPDC32(int octet, uint crc){
            return (table[(((uint)(crc)) ^ ((byte)(octet))) & 0xff] ^ (((uint)(crc)) >> 8));
        }
